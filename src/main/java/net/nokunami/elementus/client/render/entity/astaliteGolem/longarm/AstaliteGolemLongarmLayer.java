...
public class AstaliteGolemLongarmLayer<T extends AstaliteGolemLongarm> extends RenderLayer<T, AstaliteGolemLongarmModel<T>> {
...
//    );
    ...
    public AstaliteGolemLongarmLayer(RenderLayerParent<T, AstaliteGolemLongarmModel<T>> render) {
        super(render);
    }
