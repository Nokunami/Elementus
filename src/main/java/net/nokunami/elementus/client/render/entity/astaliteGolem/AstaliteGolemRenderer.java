...
@OnlyIn(Dist.CLIENT)
public class AstaliteGolemRenderer<T extends AstaliteGolem> extends MobRenderer<T, AstaliteGolemModel<T>> {
    ...
    public AstaliteGolemRenderer(EntityRendererProvider.Context context) {
