...
@OnlyIn(Dist.CLIENT)
public class SteelGolemRenderer<T extends SteelGolem> extends MobRenderer<T, SteelGolemModel<T>> {
    private static final ResourceLocation GOLEM_LOCATION = new ResourceLocation(EID, "textures/entity/golem/steel_golem/steel_golem.png");

    public SteelGolemRenderer(EntityRendererProvider.Context context) {
        super(context, new SteelGolemModel<>(context.bakeLayer(EModelLayers.STEEL_GOLEM)), 0.7F);
