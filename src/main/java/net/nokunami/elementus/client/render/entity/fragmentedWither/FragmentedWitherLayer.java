...
@OnlyIn(Dist.CLIENT)
public class FragmentedWitherLayer<T extends FragmentedWither> extends RenderLayer<T, FragmentedWitherModel<T>> {
...
//    );
    ...
    public FragmentedWitherLayer(RenderLayerParent<T, FragmentedWitherModel<T>> render) {
        super(render);
    }
