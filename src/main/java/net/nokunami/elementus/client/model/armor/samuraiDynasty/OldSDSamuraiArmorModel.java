package net.nokunami.elementus.client.model.armor.samuraiDynasty;
...
public class OldSDSamuraiArmorModel extends HumanoidModel<LivingEntity> {

    public OldSDSamuraiArmorModel(ModelPart root) {
        super(root);
    }
