package net.nokunami.elementus.client.model.armor.sniffsWeapons;
...
public class StylishArmorModel extends HumanoidModel<LivingEntity> {
    private ItemStack stack;
    public final ModelPart surcoat;
    public final ModelPart feathers;
    public final ModelPart feather_holder;

    public StylishArmorModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
        ...
        PartDefinition cap = rightArm.addOrReplaceChild("cap", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.2182F));
    ...
    public StylishArmorModel animate(LivingEntity entity, ItemStack stack, EquipmentSlot slot) {
