package net.nokunami.elementus.client.animation.definitions;
...
public class SteelGolemChestAnimation {
    public static final AnimationDefinition chestOpen = AnimationDefinition.Builder.withLength(0.25F)
            ...
            .addAnimation("chest_bottom", new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition chestClosed = AnimationDefinition.Builder.withLength(0.25F)
            .addAnimation("chest_bottom", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition walkCycle = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("chest_top", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(25.0F, 5.0F, 5.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.5F, KeyframeAnimations.degreeVec(40.0F, -10.0F, -5.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.75F, KeyframeAnimations.degreeVec(25.0F, -5.0F, -5.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("chest_top", new AnimationChannel(AnimationChannel.Targets.POSITION,
