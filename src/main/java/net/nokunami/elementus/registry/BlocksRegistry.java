...
public class BlocksRegistry {
    ...
    private static <T extends Block> RegistryObject<T> registerBlockFireProof(String name, Supplier<T> block) {
        RegistryObject<T> toReturn = BLOCKS.register(name, block);
        registerBlockItemFireProof(name, toReturn);
        return toReturn;
    }
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItemFireProof(String name, RegistryObject<T> block) {
        return ItemsRegistry.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().fireResistant()));
    }
