...
public class ModGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("ancient_city_addition_atelis_template", new ModLootModifier(new LootItemCondition[]{
                ...
                LootItemRandomChanceCondition.randomChance(0.25F).build()}, ModItems.ATELIS_UPGRADE_SMITHING_TEMPLATE.get()));
        add("ancient_city_addition_atelis_scrap", new ModLootModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("chests/ancient_city")).build(),
                LootItemRandomChanceCondition.randomChance(0.3F).build()}, ModItems.ATELIS_SCRAP.get()));
        add("ancient_city_catalyst_armor", new ModLootModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("chests/ancient_city")).build(),
                LootItemRandomChanceCondition.randomChance(0.1F).build()}, ModItems.CATALYST_CHESTPLATE.get()));
        add("ancient_city_addition_weapon_fragment", new ModLootModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("chests/ancient_city")).build(),
                LootItemRandomChanceCondition.randomChance(0.15F).build()}, ModItems.WEAPON_FRAGMENT.get()));
