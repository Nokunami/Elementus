...
public class EGlobalLootModifierProvider extends GlobalLootModifierProvider {

    public EGlobalLootModifierProvider(PackOutput output) {
        super(output, Elementus.EID);
    }
