...
public class EItemModelData extends ModItemModelProvider {
    public EItemModelData(PackOutput output, String modid, ExistingFileHelper existingFileHelper) {
    ...
    protected void registerModels() {
        ...
        generatedItem(EItems.ASTALITE_SCRAP, "ingredients");
        generatedItem(EItems.ASTALITE_INGOT, "ingredients");
        generatedItem(EItems.ASTALITE_NUGGET, "ingredients");
        ...
        handheldItem(EItems.ASTALITE_SWORD, "tools");
        handheldItem(EItems.ASTALITE_SHOVEL, "tools");
        handheldItem(EItems.ASTALITE_PICKAXE, "tools");
        handheldItem(EItems.ASTALITE_AXE, "tools");
        handheldItem(EItems.ASTALITE_HOE, "tools");
        ...
        shieldItem(EItems.ASTALITE_SHIELD, "shield");
        shieldItem(EItems.DIARKRITE_SHIELD, "shield");
        shieldItem(EItems.ANTHEKTITE_SHIELD, "shield");

        bowItem(EItems.ASTALITE_BOW, "bows");
        bowItem(EItems.DIARKRITE_BOW, "bows");
        bowItem(EItems.ANTHEKTITE_BOW, "bows");

        armorItem(EItems.ASTALITE_HELMET, "armor");
        armorItem(EItems.ASTALITE_CHESTPLATE, "armor");
        armorItem(EItems.ASTALITE_LEGGINGS, "armor");
        armorItem(EItems.ASTALITE_BOOTS, "armor");
