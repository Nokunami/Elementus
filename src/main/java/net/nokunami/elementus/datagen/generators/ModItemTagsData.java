...
public class ModItemTagsData extends ItemTagsProvider {
    ...
    private void elementusTags() {
        tag(Etags.Items.WARN)
                .addOptional(FarmersDelightItems.STEEL_KNIFE.getId()).addOptional(FarmersDelightItems.DIARKRITE_KNIFE.getId()).addOptional(FarmersDelightItems.ANTHEKTITE_KNIFE.getId())
                .addOptional(PPModItems.STEEL_PAXEL.getId()).addOptional(PPModItems.DIARKRITE_PAXEL.getId()).addOptional(PPModItems.ANTHEKTITE_PAXEL.getId()).addOptional(PPModItems.DIARKRITE_UPGRADE_KIT.getId()).addOptional(PPModItems.ANTHEKTITE_UPGRADE_KIT.getId())
                .addOptional(NethersDelightItems.STEEL_MACHETE.getId()).addOptional(NethersDelightItems.DIARKRITE_MACHETE.getId()).addOptional(NethersDelightItems.ANTHEKTITE_MACHETE.getId())

                .addOptional(ISSModItems.STEEL_SPELL_BOOK.getId()).addOptional(ISSModItems.DIARKRITE_SPELL_BOOK.getId()).addOptional(ISSModItems.ANTHEKTITE_SPELL_BOOK.getId())
                .addOptional(ISSModItems.DIARKRITE_MAGE_HELMET.getId()).addOptional(ISSModItems.DIARKRITE_MAGE_CHESTPLATE.getId()).addOptional(ISSModItems.DIARKRITE_MAGE_LEGGINGS.getId()).addOptional(ISSModItems.DIARKRITE_MAGE_BOOTS.getId())
                .addOptional(ISSModItems.ANTHEKTITE_MAGE_HELMET.getId()).addOptional(ISSModItems.ANTHEKTITE_MAGE_CHESTPLATE.getId()).addOptional(ISSModItems.ANTHEKTITE_MAGE_LEGGINGS.getId()).addOptional(ISSModItems.ANTHEKTITE_MAGE_BOOTS.getId())

                .addOptional(TAModItems.STEEL_GLOVES.getId()).addOptional(TAModItems.DIARKRITE_GLOVES.getId()).addOptional(TAModItems.ANTHEKTITE_GLOVES.getId())
                ...
                .addOptional(TWModItems.MOVCADIA_TABLE.getId())
