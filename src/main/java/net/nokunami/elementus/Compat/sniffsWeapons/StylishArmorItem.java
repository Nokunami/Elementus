...
public class StylishArmorItem extends DyeableArmorItem {
    ...
    public StylishArmorItem(CustomArmorMaterial material, Type type, String texture_type, int color, Properties properties) {
    ...
    public @Nullable String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        ...
        String s1 = String.format(Locale.ROOT, "%s:textures/models/armor/%s_%s.png", domain, this.texture_type, texture);
        return s1;
    }
}