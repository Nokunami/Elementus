...
import net.nokunami.elementus.compat.simplyswords.config.ConfigDefaultValue;
import net.nokunami.elementus.compat.simplyswords.config.EConfig;
...
public class SSItemsRegistry {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, MODID);
    static float steel_modifier =  EConfig.getFloat("steel_damageModifier", "WeaponAttributes", ConfigDefaultValue.steel_damageModifier);
    static float diarkrite_modifier = EConfig.getFloat("diarkrite_damageModifier", "WeaponAttributes", ConfigDefaultValue.diarkrite_damageModifier);
    static float anthektite_modifier = EConfig.getFloat("anthektite_damageModifier", "WeaponAttributes", ConfigDefaultValue.anthektite_damageModifier);
    static float diarkrite_atkSpeedAdd = EConfig.getFloat("darkrite_atkSpeedAdd", "WeaponAttributes", ConfigDefaultValue.darkrite_atkSpeedAdd);
    static float diarkrite_atkSpeedNeg = EConfig.getFloat("darkrite_atkSpeedNeg", "WeaponAttributes", ConfigDefaultValue.darkrite_atkSpeedNeg);
    static float anthektite_atkSpeedAdd = EConfig.getFloat("anthektite_atkSpeedAdd", "WeaponAttributes", ConfigDefaultValue.anthektite_atkSpeedAdd);
    static float anthektite_atkSpeedNeg = EConfig.getFloat("anthektite_atkSpeedNeg", "WeaponAttributes", ConfigDefaultValue.anthektite_atkSpeedNeg);
    ...
    public static final RegistryObject<Item> STEEL_CHARKRAM = ITEMS.register("steel_chakram",
            () -> new SimplySwordItem(CustomItemMaterial.STEEL,
    ...
    public static final RegistryObject<Item> DIARKRITE_CHARKRAM = ITEMS.register("diarkrite_chakram",
            () -> new SimplySwordItem(CustomItemMaterial.DIARKRITE,
    ...
    public static final RegistryObject<Item> ANTHEKTITE_CHARKRAM = ITEMS.register("anthektite_chakram",
            () -> new SimplySwordItem(CustomItemMaterial.ANTHEKTITE,
...
//    public static final RegistryObject<Item> STEEL_CHARKRAM = ITEMS.register("steel_chakram",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 2, -3.0f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_CLAYMORE = ITEMS.register("steel_claymore",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 5, -2.8f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_CUTLASS = ITEMS.register("steel_cutlass",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.4f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_GLAIVE = ITEMS.register("steel_glaive",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.6f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_GREATAXE = ITEMS.register("steel_greataxe",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 6, -3.1f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_GREATHAMMER = ITEMS.register("steel_greathammer",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 7, -3.2f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_HALBERD = ITEMS.register("steel_halberd",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 6, -2.8f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_KATANA = ITEMS.register("steel_katana",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.0f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_LONGSWORD = ITEMS.register("steel_longsword",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.4f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_RAPIER = ITEMS.register("steel_rapier",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 2, -1.8f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_SAI = ITEMS.register("steel_sai",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 0, -1.5f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_SCYTHE = ITEMS.register("steel_scythe",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 4, -2.7f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_SPEAR = ITEMS.register("steel_spear",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.7f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_TWINBLADE = ITEMS.register("steel_twinblade",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.0f,
//                    new Item.Properties()));
//    public static final RegistryObject<Item> STEEL_WARGLAIVE = ITEMS.register("steel_warglaive",
//            () -> new SimplySwordItem(CustomItemMaterial.STEEL, 3, -2.2f,
//                    new Item.Properties()));
