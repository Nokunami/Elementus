...
public class DiarkriteArmorMaterialConfig extends ArmorMaterialConfig {
    public static int helmet = 3;
    public static int chestplate = 8;
    public static int leggings = 6;
    public static int boots = 3;
    public static int durabilityMultiplier = 38;
    public static int enchantability = 12;
    public static double toughness = 4;
    public static double knockback = 0.2;
    public static double attackSpeed = 0;
    public static double movementSpeed = -0.04;

    public DiarkriteArmorMaterialConfig(final ForgeConfigSpec.Builder builder) {
        super(builder, "diarkrite", "diarkrite", helmet, chestplate, leggings, boots, durabilityMultiplier, enchantability, toughness, knockback, attackSpeed, movementSpeed);
