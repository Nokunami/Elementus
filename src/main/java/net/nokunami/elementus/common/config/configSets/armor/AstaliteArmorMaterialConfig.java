...
public class AstaliteArmorMaterialConfig extends ArmorMaterialConfig {
    public static int helmet = 3;
    public static int chestplate = 8;
    public static int leggings = 6;
    public static int boots = 3;
    public static int durabilityMultiplier = 24;
    public static int enchantability = 18;
    public static double toughness = 0;
    public static double knockback = 0;
    public static double attackSpeed = 0;
    public static double movementSpeed = 0;

    public AstaliteArmorMaterialConfig(final ForgeConfigSpec.Builder builder) {
        super(builder, "astalite", "astalite", helmet, chestplate, leggings, boots, durabilityMultiplier, enchantability, toughness, knockback, attackSpeed, movementSpeed);
    }
