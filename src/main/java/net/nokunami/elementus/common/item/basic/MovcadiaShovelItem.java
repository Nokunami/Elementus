...
public class MovcadiaShovelItem extends EShovelItem implements IMovcadiaTool {

    public MovcadiaShovelItem(Tier tier, float attackDamage, float attackSpeed, Properties properties) {
