...
public class MovcadiaAxeItem extends EAxeItem implements IMovcadiaTool {

    public MovcadiaAxeItem(Tier tier, float attackDamage, float attackSpeed, Properties properties) {
