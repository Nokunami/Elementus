...
public class MovcadiaPickaxeItem extends EPickaxeItem implements IMovcadiaTool {

    public MovcadiaPickaxeItem(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
