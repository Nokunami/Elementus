...
public class ModEntityType {
    ...
    public static final RegistryObject<EntityType<AstaliteGolem>> ASTALITE_GOLEM = ENTITY_TYPES.register("steel_golem",
    ...
    public static final RegistryObject<EntityType<SteelGolem>> OLD_STEEL_GOLEM = ENTITY_TYPES.register("steel_golem_old",
            () -> EntityType.Builder.of(SteelGolem::new, MobCategory.CREATURE).sized(SteelGolem.rawBbWidth, SteelGolem.rawBbHeight).build("steel_golem_old"));
