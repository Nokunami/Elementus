package net.nokunami.elementus.common.entity.ai.goal.astaliteGolem;
...
public class AstaliteGolemAttackGoal extends MeleeAttackGoal {
    ...
    public AstaliteGolemAttackGoal(AstaliteGolem golem, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
