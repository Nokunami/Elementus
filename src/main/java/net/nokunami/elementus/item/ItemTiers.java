...
public class ItemTiers {
    ...
    public static final ForgeTier ANTHEKTITE = new ForgeTier(
            4, 1678, 7.95F, 4F,13,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemsRegistry.ANTHEKTITE_INGOT.get()));
    public static final ForgeTier DIARKRITE = new ForgeTier(
            4, 2496, 9.25F, 5F,15,
            BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ItemsRegistry.DIARKRITE_INGOT.get()));
}
