...
import net.nokunami.elementus.mixins.EnchantmentMixin;
...
public class CustomEnchantment extends Enchantment {
    ...
    public CustomEnchantment slots( List<EquipmentSlot> slots ) {
        ( (EnchantmentMixin)this ).setSlots( slots.toArray( EquipmentSlot[]::new ) );

        return this;
    }

    public CustomEnchantment rarity( Rarity rarity ) {
        ( ( EnchantmentMixin )this ).setRarity( rarity );

        return this;
    }

    public CustomEnchantment category( EnchantmentCategory category ) {
        ( ( EnchantmentMixin )this ).setCategory( category );
