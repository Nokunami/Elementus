...
public class Etags {
    ...
    public static class Blocks {
        ...
        public static final TagKey<Block> INCORRECT_FOR_STEEL_TOOL = elementusTag("incorrect_for_steel_tool");
        public static final TagKey<Block> INCORRECT_FOR_DIARKRITE_TOOL = elementusTag("incorrect_for_diarkrite_tool");
        public static final TagKey<Block> INCORRECT_FOR_ANTHEKTITE_TOOL = elementusTag("incorrect_for_anthektite_tool");
