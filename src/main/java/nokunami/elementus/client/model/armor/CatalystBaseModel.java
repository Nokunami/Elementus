...
public class CatalystBaseModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.BodyEmissive.render(poseStack, buffer, fullBright, packedOverlay, color);
        ...
        this.rightArmEmissive.render(poseStack, buffer, fullBright, packedOverlay, color);
        this.leftArmEmissive.copyFrom(leftArm);
        this.leftArmEmissive.render(poseStack, buffer, fullBright, packedOverlay, color);
        this.rightTassetHolder.copyFrom(rightLeg);
        this.rightTassetHolder.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftTassetHolder.copyFrom(leftLeg);
        this.leftTassetHolder.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rightTassetEmissive.copyFrom(rightLeg);
        this.rightTassetEmissive.render(poseStack, buffer, fullBright, packedOverlay, color);
        this.leftTassetEmissive.copyFrom(leftLeg);
        this.leftTassetEmissive.render(poseStack, buffer, fullBright, packedOverlay, color);

        poseStack.popPose();
    }

    public void renderElytra(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
