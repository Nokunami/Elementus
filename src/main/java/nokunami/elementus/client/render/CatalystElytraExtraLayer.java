...
import nokunami.elementus.client.model.armor.CatalystBaseModel;
import nokunami.elementus.common.item.CatalystArmorItem;
import nokunami.elementus.common.item.CatalystItemUtil;
import org.jetbrains.annotations.NotNull;

import static nokunami.elementus.common.registry.ModItems.ElementusItems.CATALYST_CHESTPLATE;
...
public class CatalystElytraExtraLayer<T extends LivingEntity, M extends EntityModel<T>> extends ElytraLayer<T, M> {
    ...
    public @NotNull ResourceLocation getElytraTexture(@NotNull ItemStack stack, @NotNull LivingEntity entity) {
        return ResourceLocation.parse(CatalystItemUtil.baseTextures(stack, entity));
    }
}
